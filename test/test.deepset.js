...
describe( 'deepset cdf', function tests() {
	...
	it( 'should compute the Pareto cdf and deep set', function test() {
		var data, expected, i;
	...
	it( 'should return an empty array if provided an empty array', function test() {
		assert.deepEqual( cdf( [], alpha, beta, 'x' ), [] );
		assert.deepEqual( cdf( [], alpha, beta, 'x', '/' ), [] );
	});
